...
export const getTabHandle = (match: DataRouteMatch, storeKey: string): TabHandle | undefined => {
...
export const useTabMatches = (tab: TabModel) => {
	...
	const matches = matchRoutes(dataRouterContext.router.routes, getTabLocation(tab));
	return matches || [];
};
